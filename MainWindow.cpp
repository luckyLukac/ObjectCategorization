...
void MainWindow::multiSweep(wxCommandEvent& event) {
	...
	sweep.rotateObject(toRadians(0));		  // Rotation of the object.
	...
	std::vector<Chain> featureVector = sweep.calculateFeatureVector();  // Calculation of a feature vector for the current object.
